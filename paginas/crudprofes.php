...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a href="./crudalumnos.php" class="btn btn-secondary btn-lg " tabindex="-1" role="button" aria-disabled="true" type="button">Alumno</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <a href="#" class="btn btn-primary btn-lg " tabindex="-1" role="button" aria-disabled="true">Profesor</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
...
?>
    ...
    <div class="filtro" >
           ...
           <a href="crudprofes.php"> <input type="submit" value="Filtrar" name="enviar" class="boton_personalizado"></a>
           <td class="boton"><a href="./crudprofes.php" class="btn btn-primary" name="volver" >quitar filtros</a></td>
...
if (isset($_GET['nombre1'])) {
    ...
    echo '<a href="./crearprofes.php" class="btn btn-success btn-lg" role="button" aria-disabled="true">Crear</a>';
    echo "<br>";
    echo "<br>";
...
if (isset($_GET['nombre1'])) {
    ...
    foreach ($listadodept1 as $profes) {
        echo '<tr>';
        echo "<td class='usuario'>{$profes['nom_prof']}</td>";
        echo "<td class='usuario'>{$profes['email_prof']}</td>";
        echo "<td class='usuario'>{$profes['dni_prof']}</td>";
        echo "<td class='usuario'>{$profes['telf']}</td>";
        echo "<td class='usuario'>{$profes['curso_prof']}</td>";
    ...
    foreach ($listadodept as $alumno) {
        echo '<tr>';
        echo "<td class='usuario'>{$alumno['nom_prof']}</td>";
        echo "<td class='usuario'>{$alumno['email_prof']}</td>";
        echo "<td class='usuario'>{$alumno['dni_prof']}</td>";
        echo "<td class='usuario'>{$alumno['telf']}</td>";
        echo "<td class='usuario'>{$alumno['curso_prof']}</td>";
